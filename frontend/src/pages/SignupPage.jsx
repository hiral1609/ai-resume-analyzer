    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 dark:text-slate-400 font-medium">Start your journey to your dream job today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="block text-sm font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest ml-1">Full Name</label>
        ...
        <p className="mt-10 text-center text-slate-600 dark:text-slate-400 font-medium">
          ...
          <Link to="/login" className="text-primary-600 dark:text-primary-400 font-black hover:underline px-2 py-1 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-950/30 transition-colors">
            Login
          </Link>
        </p>
      </motion.div>
